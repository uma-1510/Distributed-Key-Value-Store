...
const file_node_proto_rawDesc = "" +
	...
	"\aKVStore\x12\x17\n" +
	"\x03Put\x12\x05.Item\x1a\t.Response\x12\x13\n" +
	"\x03Get\x12\x04.Key\x1a\x06.Value\x12\x19\n" +
	"\x06Delete\x12\x04.Key\x1a\t.ResponseB\x06Z\x04./pbb\x06proto3"
...
var file_node_proto_depIdxs = []int32{
	2, // 0: KVStore.Put:input_type -> Item
	0, // 1: KVStore.Get:input_type -> Key
	0, // 2: KVStore.Delete:input_type -> Key
	3, // 3: KVStore.Put:output_type -> Response
	1, // 4: KVStore.Get:output_type -> Value
	3, // 5: KVStore.Delete:output_type -> Response
